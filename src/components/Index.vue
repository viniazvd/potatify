...
const createErrorFeedback = () => createFeedback({ type: 'error', message: 'Error', duration: 10, autoClose: false })
const createSuccessFeedback = () => createFeedback({ type: 'success', message: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', duration: 5, autoClose: false })
const createPersistentFeedback = () => createFeedback({ type: 'info', title: "um tituleo", message: 'Get started with the rating component to show an aggregate.', autoClose: false })
...
<!--import SButton from "@components/SIcon/Index.vue";-->
